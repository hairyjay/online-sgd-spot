...
parser.add_argument('--force-exit', '-f', default=15000, type=int, help='time when run is forced to exit')
...
parser_d.add_argument('--drift-start', default=300, nargs='+', type=int, help='start time for context drift')
parser_d.add_argument('--drift-time', default=0, nargs='+', type=int, help='duration of gradual context drift')
parser_d.add_argument('--drift-cats', default=20, nargs='+', type=int, help='number of categories withheld for drift')
